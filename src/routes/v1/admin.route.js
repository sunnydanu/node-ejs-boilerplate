...
router.post('/loginPost', validate(authValidation.loginPost), authController.loginPost);
...
router.get('/pages-lock-screen', function (req, res) {
  ...
  res.render('backend/Auth/pages_lock_screen', {
    layout: false
  });
});
...
router.get('/pages-recoverpw', function (req, res) {
  ...
  res.render('backend/Auth/pages_recoverpw', {
    layout: false
  });
});
...
router.get('/pages-500', function (req, res) {
  ...
  res.render('backend/Auth/pages_500', {
    layout: false
  });
});
